...
public:
	...
	void add_wall_collision(int a, int b, int c, int d);
	...
	inline sf::Vector2f convert_to_global_space(sf::Vector2f coord) { 
		return sf::Vector2f(coord.x * 1920.0 / screen_x, coord.y * 1080.0 / screen_y); 
	};
private:
